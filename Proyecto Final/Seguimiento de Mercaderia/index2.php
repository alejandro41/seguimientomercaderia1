		...
		<div class="carousel-inner" style="border-top:18px solid #222; border-bottom:1px solid #222; border-radius:4px;">
		  <div class="item active">
			...
			<div class="carousel-caption">
				  ...
				  <p>
                      Tenemos el mejor seguimiento de mercaderia del pais siempre podras ver donde estan tus productos
				  </p>
			</div>
		  </div>
		  <div class="item">
...
<div class="row">
	...
	<h5>Descripción </h5>
	<p align="justify">
	somos una empresa emprendedora la mas rapida del pais tus productos llegaran antes de lo que crees
	</p>
	...
	<h5> Descrioción</h5>
	<p align="justify">
    Tus productos vendran seguros sin la minima posibilad que se dañen o se pierdad
	</p>
	...
	<img src="images/seguir.png"/>
	<div class="caption">
	<h5>Descripción </h5>
	<p align="justify">
	Donde quieras podras ver tus productos aqui y ahora pruebanos
	</p>
...
<hr class="soften"/>
<p>&copy; CREADOPOR LUIS GATICA Y LUIS LILLO <br/><br/></p>
 </footer>
</div><!-- /container -->
